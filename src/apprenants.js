...
export function creerApprenants(infos, position){
    ...
    position.insertAdjacentHTML(
        ...
        <div class="row g-0">
          <div class="col-md-4">
          <img src="src/image/ThiernoOmarDiouf.jpg" class="img-fluid rounded-start w-100" alt="..." style="border-radius: 5px; height: 200px;">
          </div>
          <div class="col-md-8">
            <div class="card-body">
      ...
      bouttonDetails.addEventListener("click", (event)=>{
          ...
          principal.insertAdjacentHTML(
            ...
            <div class="row g-0">
              <div class="col-md-4">
              <img src="src/image/ThiernoOmarDiouf.jpg" class="img-fluid rounded-start w-100 h-100" alt="..." style=" border-radius: 5px; max-height: 280px;">
              </div>
